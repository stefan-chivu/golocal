...
def checkout(request, client, first_name, last_name, email, address, zipcode, phone, amount):
    order = Order.objects.create(client=client, first_name=first_name, last_name=last_name, email=email, address=address, zipcode=zipcode, phone=phone, vendor_paid_amount=amount)
